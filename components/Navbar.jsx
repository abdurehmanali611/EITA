...
const Navbar = () => {
  ...
  return (
    <div 
    style={{backgroundImage: `url(${'/assets/background.jpg'})`, backgroundRepeat: 'no-repeat', backgroundPosition: 'start', backgroundSize: '100%'}}
    className='p-4'>
        <div className='flex justify-between items-center'>
            ...
            <ul className='flex gap-10'>
                   <li className='text-lg font-serif'>
                        <Link 
                        className='underline text-oregon-600 hover:text-blue-400'
                        href='/'>{t("Home")}</Link>
                    </li>
                    <li className='text-lg font-serif'>
                        <Link 
