  ...
  return (
    ...
    className='flex flex-col gap-10'>
      ...
      className='flex flex-col gap-10 text-center h-[500px] justify-center'>
        <h3 className='font-serif text-2xl font-semibold'>{t("Welcome to the Islamic Teaching Organization")}</h3>
        <h4 className='font-mono text-xl'>{t("Fostering Knowledge and Understanding")}</h4>
      </div>
      ...
      <p className="text-center w-[70%] self-center font-mono text-xl">
        {t("Through these guiding principles, Ethiopian islamic teaching association aims to cultivate an environment of learning, spirituality, and social responsibility, contributing to a harmonious and just society &#46;")}
      </p>
    </div>
  )
}
